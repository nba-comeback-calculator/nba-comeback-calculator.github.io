...
.. green-box::
    ...
    thought these notes might be useful, esp. for someone in a similar starting place
    to myself.
...
But writing good specifications takes time and effort and, being `lazy is one of the 3
virtues of being a good dev <https://thethreevirtues.com/>`_.  So with that goal in
mind, I found myself starting to use Claude more and more to write the CLAUDE.md file
and other requirements.  I would just paste in text I would be embarrassed for people
to see and ask it to clean it up, read the CLAUDE.md, ask it to tweak it again, mash my
hand against the keyboard a few more times, and then, voilà, a working spec it could
then use to write code against.  (For example, :ref:`the spec I fed into it to do the
form URL encoding was barely English <url-mashup>`).
...
and other odds and ends that save a lot of time.  It's prose style tho is still, well,
...
pages, add unicode characters and on and on.  Code completion on steriods in a sense.
...
and back tracking just like any coding project.
...
about, an on and on.  When Claude runs, it can take time.  But then your mind is free
